...
class OracleVectorStore:
    ...
    def insert_vectors(
        ...
        try:
            ...
            for i, (chunk, embedding) in enumerate(zip(chunks, embeddings)):
                ...
                # Execute individually: VECTOR() bind vars don't work with executemany (ORA-01484)
    ...
    def similarity_search(
        ...
        try:
            ...
            # Build SQL query with vector similarity (parameterized to prevent SQL injection)
            if document_id:
                search_sql = f"""
                    SELECT
                        id,
                ...
                """
                cursor.execute(search_sql, [query_list, top_k, document_id])
            else:
                search_sql = f"""
                    SELECT
                        id,
